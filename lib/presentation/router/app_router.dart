...
import '../pages/settings/micros_settings_page.dart';
import '../pages/settings/reminders_page.dart';
import '../pages/recipes/recipe_details_page.dart';
import '../pages/collections/collections_page.dart';
import '../pages/collections/import_template_page.dart';
...
final appRouterProvider = Provider<GoRouter>((ref) {
  ...
  final initial = (doneNew || doneLegacy) ? AppRouter.home : AppRouter.onboarding;
...
class AppRouter {
  ...
  static const String substitutionSettings = '/settings/substitutions';
  ...
  static const String collectionsImport = '/collections/import';
  ...
  static final List<GoRoute> _routes = [
    ...
    GoRoute(
      path: substitutionSettings,
      name: 'settings-substitutions',
      pageBuilder: (context, state) => MaterialPage<void>(
        key: state.pageKey,
        child: const SubRulesPage(),
      ),
    ),
    GoRoute(
      path: budgetSettings,
    ...
    GoRoute(
      path: collectionsImport,
      name: 'collections-import',
      pageBuilder: (context, state) => MaterialPage<void>(
        key: state.pageKey,
        child: ImportTemplatePage(initialCode: state.uri.queryParameters['code']),
      ),
    ),
  ];
}
