...
class _PlanPageState extends ConsumerState<PlanPage> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            onPressed: () {
              // TODO: Implement plan generation in Stage 3
              _showPlanGenerationDialog();
            },
  ...
  Widget _buildSwapDrawer(dynamic plan, Map<String, Recipe> recipeMap) {
    ...
    // Mock swap options (will be implemented in Stage 3)
  ...
  void _handleSwapSelected(int dayIndex, int mealIndex, Recipe newRecipe) {
    // TODO: Implement swap functionality in Stage 3
  ...
  void _showPlanGenerationDialog() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Text('Generate New Plan'),
        content: const Text(
          'This will replace your current meal plan. The planning engine will be implemented in Stage 3.',
        ),
        actions: [
          TextButton(
          ...
          FilledButton(
            onPressed: () {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Plan generation will be available in Stage 3'),
                ),
              );
            },
